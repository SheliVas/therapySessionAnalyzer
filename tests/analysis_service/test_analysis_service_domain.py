...
def test_should_call_backend_analyze_once_when_transcript_created_event_received(
...
def test_should_return_analysis_result_with_video_id_matching_event_when_transcript_created_event_received(
    event: TranscriptCreatedEvent,
    fake_backend: FakeAnalysisBackend,
) -> None:
...
def test_should_return_analysis_result_with_correct_word_count_when_transcript_created_event_received(
    event: TranscriptCreatedEvent,
    fake_backend: FakeAnalysisBackend,
) -> None:
    result = analyze_transcript(event, fake_backend)
...
def test_should_return_analysis_result_with_correct_extra_data_when_transcript_created_event_received(
    event: TranscriptCreatedEvent,
    fake_backend: FakeAnalysisBackend,
) -> None:
    result = analyze_transcript(event, fake_backend)
